...
namespace Konu16CollectionsKoleksiyonlar
{
    internal class Program
    {
        ...
        static void Ornek5()
        {
            var dictionary = new StringDictionary();//key value şeklinde veri saklayablir.
            ...
            Console.WriteLine("");
            Console.WriteLine("String Dictiobary");
            Console.WriteLine("dictiobary 18 :" + dictionary["18"]);
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("String Dictiobary Keys");
            foreach (var item in dictionary.Keys)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine();
            Console.WriteLine("String Dictiobary Values");
        ...
        static void Ornek6()
        {
            Stack stack = new();// Stack sınıfı Programlamada LIFO - son giren ilk çıkar kuralı ile çalışır
            // stack.Add(); stack de listeye add metodu ile ekleme yapılmaz
            stack.Push("Çankırı");
            stack.Push("Ankara");
            stack.Push("İstanbul");
            stack.Push("Karabük");
            ...
            while (stack.Count > 0)
            {
                Console.WriteLine(stack.Pop());//Stack de nesneler üst üste koyulmuş gibidir verelere üsten çekerek ulaşır.Masaya yığımış kitap gibi            
            }
        }
        static void Ornek7()
        {
            Queue queue = new();//Queu sınıfı prpgramlama da FIFO-ilk giren ilk çıkar mantığı ile çalışır
            queue.Enqueue("Lale");
            queue.Enqueue("Gül");
        ...
        static void ListKullanimi()
        {
            ...
            sehirler.Add("Ankara");//1. liste oluşturma tekniği
            ...
            Console.WriteLine();
            List<User> users = new();//ikinci liste oluşturma tekniği
            users.Add(new User
            {
                Id = 1,
                Name = "Sumeyye",
            ...
            List<User> kullanicilar = new()//3. liste oluşturma tekniği
            {
                new User
                {
                Id = 3,
            ...
            Console.WriteLine("Kullanıcılar listesinde yenikullanici var mi? "+kullanicilar.Contains(yenikullanici));//liste içinde kelimeyi arar
           
            kullanicilar.Add(yenikullanici);//ekldeik

            Console.WriteLine("Kullanıcılar listesinde yenikullanici var mi? " + kullanicilar.Contains(yenikullanici));
            Console.WriteLine();
