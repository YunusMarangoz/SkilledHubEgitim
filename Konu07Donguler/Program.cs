namespace Konu07Donguler
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var kategori in kategoriler)// kategori (dizi ogesi) kategoriler dizsindeki her bir elemeana karşılık geliyor
            { 
            ...
            Console.WriteLine();
            Console.WriteLine("iç İçe For Döngüsü");
            for (int i = 0; i < 5; i++)
            {
                Console.WriteLine($"i değişkeninin değeri {i}");// Console.WriteLine("i değişkeninin değeri {0}", i); yazımları aynı
                for (int k = 0; k < 3; k++)
                {
